...
$sql .= " ORDER BY user_id ASC LIMIT $itemsPerPage OFFSET $offset";
...
$totalRecords = $conn->query("SELECT COUNT(*) FROM user")->fetchColumn();
...
<body>
    <main class="d-flex">
        ...
        <div class="container mt-3 vh-100">
            <h1 class="d-flex">จัดการข้อมูลผู้ใช้งาน
                <div class="d-flex align-items-center">
                    <button type="button" class="btn btn-outline-primary ms-2" onclick="document.location='user_add.php'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z" />
                            <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z" />
                        </svg>
                        <span class="ms-2">เพิ่มผู้ใช้งาน</span>
                    </button>
                ...
                <tbody>
                    <?php foreach ($result as $user) { ?>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <button type="button" class="btn btn-outline-warning" onclick="document.location='user_edit.php?iduser=<?= $user['user_id']; ?>'">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-gear" viewBox="0 0 16 16">
                                            <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm.256 7a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Zm3.63-4.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382l.045-.148ZM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z" />
                                        </svg>
                                        <span class="ms-2">แก้ไขผู้ใช้งาน</span>
                                    </button>
                                    <button type="button" class="btn btn-outline-danger" onclick="document.location='user_delete.php?iduser=<?= $user['user_id']; ?>'">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-dash" viewBox="0 0 16 16">
                                            <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7ZM11 12h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1Zm0-7a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" />
                                            <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z" />
                                        </svg>
                                        <span class="ms-2">ลบผู้ใช้งาน</span>
                                    </button>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="container">
                <div class="text-center">
                    <ul class="pagination justify-content-center">
                        <?php
                        if ($page > 1) {
                            echo "<li class='page-item'><a class='page-link' href='user_management.php?page=" . ($page - 1) . "'>Previous</a></li>";
                        }
                        ...
                        for ($i = 1; $i <= $totalPages; $i++) {
                            if (
                                ...
                                echo "'><a class='page-link' href='user_management.php?page=$i'>$i</a></li>";
                            } elseif (
                        ...
                        if ($page < $totalPages) {
                            echo "<li class='page-item'><a class='page-link' href='user_management.php?page=" . ($page + 1) . "'>Next</a></li>";
                        }
                        ?>
                    </ul>
                </div>
