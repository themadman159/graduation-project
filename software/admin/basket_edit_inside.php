...
$sql = "SELECT * FROM basket INNER JOIN sale ON basket.sale_id = sale.sale_id WHERE sale.sale_id = '$sale_id'";
...
$totalRecords = $conn->query("SELECT COUNT(*) FROM basket WHERE sale_id = '$sale_id'")->fetchColumn();
                ...
                <tbody>
                    <?php foreach ($result as $basket) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-warning mx-2" onclick="document.location='basket_edit_detail.php?basket_id=<?= $basket['basket_id'] ?>&sale_id=<?= $basket['sale_id'] ?>'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
                                        <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z" />
                                    </svg>
                                    แก้ไขสินค้า
                                </button>
                                <button type="button" class="btn btn-outline-danger" onclick="document.location='basket_product_delete_inside.php?basket_id=<?= $basket['basket_id'] ?>&sale_id=<?= $basket['sale_id'] ?>'">
            ...
            <div class="container">
                <div class="text-center">
                    <ul class="pagination justify-content-center">
                        <?php
                        if ($page > 1) {
                            echo "<li class='page-item'><a class='page-link' href='basket_edit_inside.php?page=" . ($page - 1) . "&sale_id=" . ($sale_id) . "'>Previous</a></li>";
                        }
                        ...
                        for ($i = 1; $i <= $totalPages; $i++) {
                            if (
                                ...
                                echo "'><a class='page-link' href='basket_edit_inside.php?page=$i&sale_id=" . ($sale_id) . "'>$i</a></li>";
                            } elseif (
                        ...
                        if ($page < $totalPages) {
                            echo "<li class='page-item'><a class='page-link' href='basket_edit_inside.php?page=" . ($page + 1) . "&sale_id=" . ($sale_id) . "'>Next</a></li>";
                        }
                        ?>
                    </ul>
                </div>
